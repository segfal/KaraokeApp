...
const Signup = () => {
    ...
    return (
        <div className="bg-lightGreen font-montserrat min-h-[calc(100vh-208px)] pt-16 flex flex-col items-center justify-center">
        <h1 className="text-3xl sm:text-4xl pb-8 font-extra-extrabold text-center">
          Welcome to the Serenade community!
        </h1>
        <div className="flex flex-col justify-center items-center font-montserrat rounded-lg py-6 shadow px-4 sm:px-10 mx-auto bg-mainGreen w-full sm:w-4/5 md:w-3/5 lg:w-1/2 xl:w-1/3">
          <h1 className="font-semibold text-mainWhite text-lg mb-4 text-center">
          ...
          >
            ...
            <div className="bg-bgGreen rounded p-2 mb-4 w-full max-w-md flex flex-col items-center justify-center mt-2 sm:mt-4">
            ...
            <button
              type="submit"
              className="text-center font-extra-extrabold bg-mainYellow rounded-md hover:bg-mainWhite transition-colors duration-200 ease-in-out p-2 w-full max-w-md mt-4"
            >
              SIGN UP
            </button>
          </form>
