...
<div className="bg-lightGreen font-montserrat h-[calc(100vh-208px)] pt-16 flex flex-col items-center justify-center">
  ...
  <div className="flex flex-col justify-center items-center font-montserrat rounded-lg py-6 shadow px-6 sm:px-10 mx-auto bg-mainGreen w-full sm:w-2/3">
    <h1 className="font-semibold text-mainWhite text-xl sm:text-lg">
    ...
    <form
      ...
      {error && (
        <p className="text-red-500 font-semibold text-base sm:text-xl">
      ...
      <input
        ...
        placeholder="Email"
        name="email"
        className="rounded p-2 mt-4 w-full sm:w-64"
      />
      <input
        type="password"
        onChange={(e) => {
        ...
        name="password"
        className="rounded p-2 my-4 w-full sm:w-64"
      />
      <button
        type="submit"
