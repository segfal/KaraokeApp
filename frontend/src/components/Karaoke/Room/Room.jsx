...
const Room = () => {
  ...
  return (
    <div className='bg-lightGreen font-montserrat flex flex-col'>
      ...
      <ChatBox roomId={room} />
      <Participants />
      <button onClick={handleLeaveRoom} className="font-extra-extrabold bg-red-700 text-white rounded-md hover:bg-mainWhite transition-colors duration-200 ease-in-out p-2 mb-2 w-16">Leave</button>
    </div>
  );
};
